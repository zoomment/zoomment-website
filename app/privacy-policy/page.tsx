      ...
      <Typography>
        <div style={{ padding: '0 20px', width: '100%' }}>
          ...
          <div>
            ...
            <Paragraph>zoomment.com</Paragraph>
            <Paragraph>
              <strong>Owner contact email:</strong> zoomment.com@gmail.com
            </Paragraph>
          </div>
          ...
          <div>
            <Title level={2} id="cookie_policy">
              Cookie Policy
            </Title>
            <Paragraph>
              ...
              the{' '}
              <a
                href="//www.iubenda.com/privacy-policy/28940703/cookie-policy?ifr=true&amp;height=687&amp;newmarkup=no"
                title="Cookie Policy"
              >
                Cookie Policy
              </a>
          ...
          <Title level={2} id="cookie_policy_further_information">
            Further Information for Users
          </Title>

          <Title level={3}>Legal basis of processing</Title>
          <Paragraph>
          ...
          <Title level={3}>Further information about retention time</Title>
          ...
          <Title level={3} id="rights_subjects">
          ...
          <Title level={4}>How to exercise these rights</Title>
          <Paragraph>
          ...
          <div>
            <Title level={2} id="further_data_processing_info">
            ...
            <Title level={3}>System logs and maintenance</Title>
            <Paragraph>
            ...
            <Title level={3}>Information not contained in this policy</Title>
            <Paragraph>
            ...
            <Paragraph>
              ...
              modification listed at the bottom. <br />
              <br />
        ...
        <div >
          ...
          <div >
            <Title level={4}>Personal Data (or Data)</Title>
            <Paragraph>
            ...
            <Title level={4}>Data Subject</Title>
            <Paragraph>The natural person to whom the Personal Data refers.</Paragraph>

            <Title level={4}>Data Processor (or Processor)</Title>
            <Paragraph>
            ...
            <Title level={4}>Data Controller (or Owner)</Title>
            <Paragraph>
              The natural or legal person, public authority, agency or other
            ...
            <Title level={4}>This Application</Title>
            <Paragraph>
            ...
            <Title level={4}>European Union (or EU)</Title>
            <Paragraph>
          ...
          <div>
            <Paragraph>Latest update: March 11, 2024</Paragraph>
          </div>
        </div>
      </Typography>
    </div>
